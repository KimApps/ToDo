...
class StartPresenter(private val view: StartView) {
    ...
    fun init() {
        view.setBtnImg1(PrefProvider.startImg1 ?: uri + R.drawable.btn_todo)
        view.setBtnImg2(PrefProvider.startImg2 ?: uri + R.drawable.btn_family)
        view.setBtnImg3(PrefProvider.startImg3 ?: uri + R.drawable.btn_alarm)
        ...
        view.setBtnText1(PrefProvider.startText1 ?: App.instance.getStringApp(R.string.todo))
        view.setBtnText2(PrefProvider.startText2 ?: App.instance.getStringApp(R.string.family))
        view.setBtnText3(PrefProvider.startText3 ?: App.instance.getStringApp(R.string.alarms))
    ...
    fun getPath(button: String): String {
        ...
        when (button) {
            BUTTON_1 -> path = PrefProvider.backImg1 ?: uri + R.drawable.back_todo
            BUTTON_2 -> path = PrefProvider.backImg2 ?: uri + R.drawable.back_family
            BUTTON_3 -> path = PrefProvider.backImg3 ?: uri + R.drawable.back_alarm
